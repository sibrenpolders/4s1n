...
public class StatusBijhouderTest extends TestCase {
	...
	public void testPop_Push_undo() {
		...
		// testObjecten poppen, faalt wanneer het gepopte element niet het gepushte element was
		assertEquals("Push/Pop faalt.", true, m4.equals(statusBijhouder.pop_undo()));
		assertEquals(3, statusBijhouder.getUndoSize());
		assertEquals("Push/Pop faalt.", true, m3.equals(statusBijhouder.pop_undo()));
		assertEquals(2, statusBijhouder.getUndoSize());
		assertEquals("Push/Pop faalt.", true, m2.equals(statusBijhouder.pop_undo()));
		assertEquals(1, statusBijhouder.getUndoSize());
		assertEquals("Push/Pop faalt.", false, m4.equals(statusBijhouder.pop_undo()));
	...
	public void testPop_Push_redo() {
		...
		assertEquals("Geen elementen faalt.", null, statusBijhouder.pop_redo());
		...
		// testObjecten poppen, faalt wanneer het gepopte element niet het gepushte element was
		assertEquals("Push/Pop faalt.", true, m4.equals(statusBijhouder.pop_redo()));
		assertEquals(3, statusBijhouder.getRedoSize());
		assertEquals("Push/Pop faalt.", true, m3.equals(statusBijhouder.pop_redo()));
		assertEquals(2, statusBijhouder.getRedoSize());
		assertEquals("Push/Pop faalt.", true, m2.equals(statusBijhouder.pop_redo()));
		assertEquals(1, statusBijhouder.getRedoSize());
		assertEquals("Push/Pop faalt.", false, m4.equals(statusBijhouder.pop_redo()));

...
abstract public class JunitAITest extends TestCase {
	...
	// Deze methode zal een veld genereren zodat de te plaatsen tegel
	// (plaatsTegel) maar op 1 positie geplaatst kan worden
	// gewenstPositie is deze positie gewensteTegel is de tegel die daar moet
	// komen.
	protected void maakEnkelVeld(TafelVerwerker tafel) {
	}

	// Deze methode zal een veld genereren zodat de te plaatsen tegel
	// (plaatsTegel) maar op meerder posities geplaatst kan worden.
	// GewensteTegelPositie is de positie waarnaar onze voorkeur gaat.
	...
	// Deze methode zal een veld genereren zodat de te plaatsen tegel
	// (plaatsTegel) niet op het veld geplaatst kan worden. GewensteTegelPositie
	// is dus null.
	...
	// Deze methode maakt een startveld aan (alleen de start tegel is al
	// geplaatst)
	...
	// Maakt een veld aan waarbij de pion niet op de laatste tegel mag staan.

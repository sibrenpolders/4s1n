...
public class JunitTegelTest extends TestCase {
	...
	public void testBepaalLandsdeel() {
		...
		assertEquals("getLandsDeel 0", Landsdeel.WEI, tegel.bepaalLandsdeel(0)
				.getType());
		assertEquals("getLandsDeel 1", Landsdeel.STAD, tegel.bepaalLandsdeel(1)
				.getType());
		assertEquals("getLandsDeel 2", Landsdeel.STAD, tegel.bepaalLandsdeel(2)
				.getType());
		assertEquals("getLandsDeel 3", Landsdeel.STAD, tegel.bepaalLandsdeel(3)
				.getType());
		assertEquals("getLandsDeel 4", Landsdeel.STAD, tegel.bepaalLandsdeel(4)
				.getType());
		assertEquals("getLandsDeel 5", Landsdeel.STAD, tegel.bepaalLandsdeel(5)
				.getType());
		assertEquals("getLandsDeel 6", Landsdeel.STAD, tegel.bepaalLandsdeel(6)
				.getType());
		assertEquals("getLandsDeel 7", Landsdeel.WEI, tegel.bepaalLandsdeel(7)
				.getType());
		assertEquals("getLandsDeel 8", Landsdeel.WEI, tegel.bepaalLandsdeel(8)
				.getType());
		assertEquals("getLandsDeel 9", Landsdeel.WEI, tegel.bepaalLandsdeel(9)
				.getType());
		assertEquals("getLandsDeel 10", Landsdeel.WEI, tegel
				.bepaalLandsdeel(10).getType());
		assertEquals("getLandsDeel 11", Landsdeel.WEI, tegel
				.bepaalLandsdeel(11).getType());
		assertEquals("getLandsDeel 12", Landsdeel.WEI, tegel
				.bepaalLandsdeel(12).getType());
	}
	...
	public void testDraaiTegel() {
		...
		assertEquals("Volledig draaien van de tegel (rechtsom)", 0, tegel
				.getOrientatie());
		...
		assertEquals("Volledig draaien van de tegel (linksom)", 0, tegel
				.getOrientatie());
		// na volledige draaiing nog 1 stap verder gaan
		tegel.draaiTegel(false);

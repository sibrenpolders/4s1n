...
public class Tafel implements Serializable {
	...
	/**
	 * Deze functie zal nagaan of de tegel met co√∂rdinaten (rij, kolom) de
	 ...
	 * @return True als dit de co√∂rdinaten zijn van de laatstgeplaatste tegel,
	 *         False anders.
	 */
	...
	/**
	 * Zal indien mogelijk pion plaatsen op de tegel met coˆrdinaten tegelCoord.
	 * pionCoord zal bepalen op welk deel de pion zal staan.
	 * 
	 * @param tegelCoord
	 *            coˆrdinaten van de tegel waar een pion op geplaatst zal
	 *            worden.
	 * @param pionCoord
	 *            coˆrdinaten van het landsdeel op de tegel waar de pion zal
	 *            geplaatst worden.
	 * @param pion
	 ...
	 * coˆrdinaten tegelCoord op het landsdeel met co√∂rdinaten pionCoord. Deze
	 * functie zal niet de pion echt gaan plaatsen op de tegel.
	 * 
	 * @param t
	 *            De tegel waarop de pion geplaatst moet worden.
	 * @param tegelCoord
	 *            De coˆrdinaten van de tegel waarop de pion geplaatst moet
	 *            worden.
	 * @param pionCoord
	 *            De coˆrdinaten van het landsdeel waarop de pion geplaatst moet
	 *            worden.

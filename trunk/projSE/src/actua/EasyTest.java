...
public class EasyTest extends AITest {
	...
	protected void geenPionPlaatsingTest() {
		...
		assertEquals("Fout bij geen pion plaatsing mogelijk", null, berekendePositie);		
	}
	...
	protected void pionPlaatsingTest() {
		...
		berekendePositie = ai.BerekenPion(veld, laatstGeplaatst);
		assertEquals("Fout bij pion plaatsing mogelijk", 
				gewenstePositie, berekendePositie);		
	}	
...
//		assert("Fout bij 1 mogelijke plaatsing", geldigeZet(berekendePositie));
